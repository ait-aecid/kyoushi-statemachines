...
class Statemachine(SeleniumStatemachine[Context]):
    ...
    def __init__(
        self,
        wpdiscuz_config: WpDiscuzConfig,
        wp_editor_config: WordpressEditorConfig,
        initial_state: str,
        states: List[State],
        ...
        self._wp_editor: WordpressEditorConfig = wp_editor_config
        self._wpdiscuz: WpDiscuzConfig = wpdiscuz_config
...
class StatemachineFactory(sm.StatemachineFactory):
    ...
    def build(self, config: StatemachineConfig):
        ...
        initial = ActivitySelectionState(
            ...
            ssh_user_weight=states_config.activities.ssh_user,
            web_browser_weight=states_config.activities.web_browser,
            wp_editor_weight=states_config.activities.wp_editor,
            wpdiscuz_weight=states_config.activities.wpdiscuz,
            idle_weight=states_config.activities.idle,
